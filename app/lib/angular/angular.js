 ...
 * 
 * <pre>
 * var WebGl = angular.module('WebGl', []);
 * WebGl.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://WebGl.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://WebGl.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('WebGl', []).config(function($sceDelegateProvider) {
 ...
 *        'http://WebGl.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="WebGlController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("WebGlController", function WebGlController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('WebGlWithSceDisabledWebGl', []).config(function($sceProvider) {
